...
export default function Form() {
    ...
    const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        router.push('/v1/auth/signup/onboarding/2');
    }
    return (
        <div className='flex flex-col p-8 items-center justify-start h-dvh text-left md:flex-row md:items-start md:justify-start gap-8'>
            <div className="aspect-square w-1/2 max-w-[590px] sm:hidden md:block">
                <DotLottieReact
                    src="https://lottie.host/3092dfb5-3de6-4c3d-8916-f7f6315d6ccb/8GBhAwQJQY.lottie"
                    loop
                    autoplay
            ...
            <div className='w-1/2 gap-2 flex flex-col'>
                <div className='flex flex-col items-start justify-start mb-4 md:mb-0 gap-2'>
                ...
                <div className='flex flex-col items-start justify-start mb-8 mt-4 gap-2'>
